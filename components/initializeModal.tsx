...
const haveThanks =
  ...
  async () => {
    ...
    let builder = transactionBuilder()
      .add(addMemo(umi, { memo: "Thanks from Team Ozone" }))
      .add(
        transferSol(umi, {
    ...
    try {
      ...
      toast({
        title: "Thank you! 🍻",
        description: `Have Cheers 🍺 together!`,
        status: "success",
        duration: 99999999,
        isClosable: true,
      });
  ...
  return (
    <>
      <VStack>
        ...
        <HStack>
          <Button
            onClick={initializeGuards(umi, candyMachine, candyGuard, toast)}
          >
            Initialize Guards
          </Button>
        ...
        <HStack>
          <LetsHaveThanks value={amount} setValue={setAmount} />
          <Button onClick={haveThanks(umi, amount, toast)}>
            Let Have thanks
          </Button>
        </HStack>
